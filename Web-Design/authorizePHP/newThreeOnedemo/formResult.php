...
$sql = "INSERT INTO users (firstName, lastName, userLogin, userEmail, phone, userGender, hash, comment) VALUES ('$userBD', '$userBDSurName', '$login', '$email', '$phone', '$gender', '$hash', '$comment')";
